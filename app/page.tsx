      ...
      <section className="relative w-full h-[100svh] min-h-[600px] flex items-center overflow-hidden">
        ...
        >
          ...
          >
            <motion.h1
              variants={fadeUp}
              className="text-6xl sm:text-7xl md:text-8xl font-black text-white tracking-tighter leading-[1.1] mb-8"
            >
            ...
            <motion.p
              variants={fadeUp}
              className="text-lg md:text-2xl text-blue-50 font-medium mb-10 max-w-xl leading-relaxed"
            >
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/proizvodi"
                className="group flex items-center justify-center gap-2 bg-white text-[#4a6bfe] font-bold text-lg py-4 px-8 rounded-full shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:shadow-[0_8px_40px_rgba(74,107,254,0.4)] transition-all duration-300 hover:scale-[1.02]"
              >
                Istraži ponudu
        ...
        >
          <span className="text-white/60 text-xs font-semibold tracking-widest uppercase">Skrolaj</span>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.div
              variants={fadeUp}
              whileHover={{ y: -10 }}
              className="bg-white rounded-3xl p-10 flex flex-col hover:shadow-2xl transition-all duration-300 border border-gray-100 relative group overflow-hidden"
            >
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 text-[#4a6bfe] p-5 rounded-2xl mb-8 w-fit shadow-inner">
                <Shirt size={40} className="stroke-[1.5]" />
              </div>
              <h3 className="text-2xl font-black text-gray-900 mb-4 tracking-tight">Sportska Oprema</h3>
              ...
              <Link href="/proizvodi" className="font-bold text-[#4a6bfe] flex items-center gap-2 group-hover:gap-3 transition-all">
            ...
            <motion.div
              variants={fadeUp}
              whileHover={{ y: -10 }}
              className="bg-gray-900 rounded-3xl p-10 flex flex-col shadow-2xl transition-all duration-300 relative group overflow-hidden md:-mt-8 md:mb-8 border border-gray-800"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-[#4a6bfe]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

              {/* Special highlight badge */}
              <div className="absolute top-6 right-6 bg-[#4a6bfe] text-white text-xs font-bold uppercase tracking-wider py-1.5 px-3 rounded-full shadow-lg">
                Najprodavanije
              </div>

              <div className="bg-[#4a6bfe]/20 text-[#4a6bfe] p-5 rounded-2xl mb-8 w-fit backdrop-blur-sm border border-[#4a6bfe]/30 shadow-[0_0_30px_rgba(74,107,254,0.3)]">
                <CircleDot size={40} className="stroke-[1.5] text-blue-400" />
              </div>
              <h3 className="text-2xl font-black text-white mb-4 tracking-tight">Automirisi - Dresovi</h3>
              ...
              <Link href="/proizvodi" className="font-bold text-white flex items-center gap-2 group-hover:gap-3 transition-all">
                Naruči odmah <ArrowRight className="w-4 h-4 text-[#4a6bfe]" />
              </Link>
            </motion.div>
            ...
            >
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100/50 text-purple-600 p-5 rounded-2xl mb-8 w-fit shadow-inner">
                <Wine size={40} className="stroke-[1.5]" />
              </div>
              <h3 className="text-2xl font-black text-gray-900 mb-4 tracking-tight">Gravirane čaše</h3>
              <p className="text-gray-500 text-base leading-relaxed mb-6 flex-grow">
                Unikatne i personalizirane čaše visoke kvalitete. Savršen poklon za sve Vaše posebne prigode i proslave.
              </p>
              <Link href="/proizvodi" className="font-bold text-purple-600 flex items-center gap-2 group-hover:gap-3 transition-all">
                Saznaj više <ArrowRight className="w-4 h-4" />
              </Link>
            </motion.div>
          </motion.div>
