    ...
    <div className="flex min-h-screen flex-col bg-[#F9FAFB] text-gray-900 selection:bg-[#4a6bfe] selection:text-white">
      ...
      <main className="relative flex-1 overflow-hidden pb-24 pt-36">
        ...
        <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <Link
            href="/proizvodi"
            className="mb-8 inline-flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-4 py-2 text-sm font-semibold text-gray-700 transition-all hover:border-gray-300 hover:text-gray-900"
          >
            <ArrowLeft size={15} />
            Nazad na proizvode
          </Link>
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10">
            <article className="relative overflow-hidden rounded-3xl border border-gray-800 bg-gray-900 p-8 shadow-2xl sm:p-10">
              ...
              <Link
                href="/kontakt"
                className="relative mt-8 inline-flex items-center gap-2 rounded-xl bg-[#4a6bfe] px-6 py-3 font-bold text-white shadow-[0_10px_30px_rgba(74,107,254,0.35)] transition-all hover:bg-[#3b5af0]"
              >
                Posalji upit za ovaj proizvod
              </Link>
            </article>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
              {relatedProducts.map((item) => (
                <Link
                  ...
                  className="group rounded-3xl border border-gray-100 bg-white p-6 shadow-[0_8px_30px_rgba(15,23,42,0.08)] transition-all hover:-translate-y-1 hover:shadow-[0_12px_35px_rgba(15,23,42,0.16)]"
                >
                  <div className="mb-4 inline-flex rounded-xl border border-blue-100 bg-blue-50 p-3">
