...
export const PRODUCTS_TABLE: ProductRecord[] = [
  {
    ...
    category: "Automirisi",
    images: ["/img/products/dinamo-plavi-automiris.png", "/img/products/placeholder-product.svg"],
  ...
  },
  {
    ...
    category: "Automirisi",
    images: ["/img/products/slaven-belupo-automiris.png", "/img/products/placeholder-product.svg"],
  ...
  },
  {
    ...
    category: "Automirisi",
    images: ["/img/products/placeholder-product.svg"],
